package iss.nus.vttp.server.controllers.jwt;
...
import iss.nus.vttp.server.models.dto.AuthRequest;
...
import iss.nus.vttp.server.service.auth.AuthService;
import iss.nus.vttp.server.utils.JwtUtil;
...
public class AuthController {
    ...
    public void createAuthenticationToken(@RequestBody AuthRequest authenticationRequest, HttpServletResponse response) throws BadCredentialsException, DisabledException, UsernameNotFoundException, IOException, JSONException, ServletException {
        try {
